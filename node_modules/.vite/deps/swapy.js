...
var Wt = (n, t, e) => t in n ? Ot(n, t, { enumerable: true, configurable: true, writable: true, value: e }) : n[t] = e;
...
var Ht = (n, t, e) => t in n ? Ut(n, t, { enumerable: true, configurable: true, writable: true, value: e }) : n[t] = e;
var a = (n, t, e) => (Ht(n, typeof t != "symbol" ? t + "" : t, e), e);
var Y = class {
  constructor(t) {
...
var Bt = class {
  ...
  _createTemporaryView(t) {
    const e = t.previousRect.viewportOffset, i = t.previousRect.size, r = t.rotation.degrees < 0 ? 0 : Math.sin(t.rotation.radians) * i.height * t.scale.y, s = t.rotation.degrees > 0 ? 0 : Math.sin(t.rotation.radians) * i.width * t.scale.y, o = t.element.cloneNode(true);
    ...
    return l.setAsTemporaryView(), l.styles.position = "absolute", l.styles.left = `${e.left + r}px`, l.styles.top = `${e.top - s}px`, l.rotation.setDegrees(t.rotation.degrees, false), l.scale.set({ x: t.scale.x, y: t.scale.y }, false), l.size.set(
...
var u = class _u {
  ...
  get unitVector() {
    const t = new _u(0, 0), e = this.magnitude;
  ...
  static scale(t, e) {
    return new _u(t.x * e, t.y * e);
  }
  static sub(t, e) {
    return new _u(t.x - e.x, t.y - e.y);
  }
  static add(t, e) {
    return new _u(t.x + e.x, t.y + e.y);
  }
...
var Qt = class {
  ...
  _observe() {
    ...
    const e = new MutationObserver(() => {
      var s;
      (s = this._callback) == null || s.call(this, false);
    }), i = {
      attributes: true,
      childList: true,
      attributeOldValue: true
    ...
    e.observe(this._element, i), new ResizeObserver(() => {
      var s;
      (s = this._callback) == null || s.call(this, true);
    }).observe(this._element);
    function r(s, o) {
      let l, h = true;
      return function() {
        h && (s(), h = false), clearTimeout(l), l = setTimeout(() => {
          s(), h = true;
        }, o);
      };
    }
...
function Q(n, t) {
  const e = {
    set: (i, r, s) => (typeof i[r] == "object" && i[r] !== null ? i[r] = Q(s, t) : (t(), i[r] = s), true),
...
var I = class {
  ...
  _setTarget(t, e = true) {
    var i, r;
    this._previousValue = F(this._currentValue), this._targetValue = t, e ? ((r = (i = this._animator).reset) == null || r.call(i), this.animator.markAsAnimating()) : this._currentValue = t, this._hasChanged = true;
  }
  hasChanged() {
...
var Ee = class extends I {
  ...
  get shouldRender() {
    ...
    ) && bt(this.renderValue.h, this._previousRenderValue.h)) : true : false;
  }
  get renderValue() {
...
var Ae = class extends I {
  ...
  update(t, e) {
    if ((this._view.isInverseEffectEnabled || this._view.isLayoutTransitionEnabled) && !this._view.isTemporaryView && this._runLayoutTransition(), this._view.isInverseEffectEnabled) {
      ...
      this._parentScaleInverse = new u(1 / d, 1 / c), this._parentScaleInverse.equals(new u(1, 1)) || (this._hasChanged = true);
    }
  ...
  _runLayoutTransition() {
    ...
    let h = false;
    if (r !== 0 || s !== 0 || !Number.isNaN(o) && o !== 1 || !Number.isNaN(l) && l !== 1 ? h = true : h = (() => {
      ...
      g = Number.isFinite(g) ? g : 0, P = Number.isFinite(P) ? P : 0, this._setTarget(new u(g, P), false);
    } else
      this._animateLayoutUpdateNextFrame && (this._setTarget(this._initialValue, true), this._animateLayoutUpdateNextFrame = false);
  }
  get shouldRender() {
    if (!this._hasChanged)
      return false;
...
var Ie = class extends I {
  ...
  _runLayoutTransition() {
    ...
    let r = false;
    if ((!Number.isNaN(e) && e !== 1 || !Number.isNaN(i) && i !== 1) && (r = true), r) {
...
var Se = class {
  ...
  _createNewView(t, e, i) {
    ...
    return i.addView(s), s.layoutId && this._layoutIdToViewMap.set(s.layoutId, s), this._createChildrenForView(s, i), this._appEventBus.emitPluginReadyEvent(i.pluginName, i.api, true), requestAnimationFrame(() => {
      requestAnimationFrame(() => {
...
var Mt = class extends rt {
  ...
  _emitEvent(t, e, i = false) {
    ...
    if (!f || !t.hasElement(f))
      return;
    const b = this._pointerDownPerView.get(t.id) === true;
  ...
  subscribeToEvents(t) {
    t.subscribeToEvent(it, ({ x: e, y: i, target: r }) => {
      this.getViews().forEach((s) => {
        this._targetPerView.set(s.id, r), s.intersects(e, i) && this._viewIsPointerDownMap.set(s.id, true);
      });
    }), t.subscribeToEvent(et, ({ x: e, y: i }) => {
      ...
      this.getViews().forEach((s) => {
        ...
        }), this._viewPointerPositionLog.set(s.id, []), this._viewIsPointerDownMap.set(s.id, false);
      });
      function r(s, o) {
        const l = {
...
var N = (n) => {
  ...
  t.on(Ft, X);
  let e, i, r, s, o = /* @__PURE__ */ new Map(), l = /* @__PURE__ */ new Map(), h, d, c, p, w = true, m, y, f;
  n.api({
    setEnabled(g) {
      w = g;
    }
  ...
  function L(g) {
    const P = C();
    g.styles.position = "relative", g.styles.touchAction = "none", g.styles.userSelect = "none", g.styles.webkitUserSelect = "none", g.position.setAnimator(P.animator, P.config), g.scale.setAnimator(P.animator, P.config), g.layoutTransition(true);
  ...
  function S() {
    ...
    n.getViews("root-child").forEach((v) => {
      v.position.setAnimator(g.animator, g.config), v.scale.setAnimator(g.animator, g.config), v.layoutTransition(true);
    });
  }
  function M() {
    if (!m) return;
...
function We(n) {
  ...
  return e.length === 0 && (console.error("There are no slots defined in your root element:", n), t = false), e.forEach((i) => {
    const r = i, s = r.dataset.swapySlot;
    (!s || s.length === 0) && (console.error(i, "does not contain a slotId using data-swapy-slot"), t = false);
    const o = r.children;
